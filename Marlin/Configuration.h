...
// uncomment for LCD 128 X 64 Full Graphics with Megatronics V2.0 Board 
...
//I2C PANELS (Do not uncomment this line)

//#define LCD_I2C_SAINSMART_YWROBOT (Do not uncomment this line)
...
//#define LCD_I2C_PANELOLU2 (Do not uncomment this line)
...
//#define LCD_I2C_VIKI (Do not uncomment this line)
//#ifdef LCD_I2C_VIKI
  // This uses the LiquidTWI2 library v1.2.3 or later ( https://github.com/lincomatic/LiquidTWI2 )
  // Make sure the LiquidTWI2 directory is placed in the Arduino or Sketchbook libraries subdirectory.
...
//  #define NEWPANEL  //enable this if you have a click-encoder panel
  ...
  #define ULTRA_LCD
		...
		#define LCD_WIDTH 20    // should comment if uncomment line below
		#define LCD_HEIGHT 5    // should comment if uncomment line below
		//#define LCD_WIDTH 128 //uncomment if using 128x64 LCD
		//#define LCD_HEIGHT 64 //uncomment if using 128x64 LCD
	#else
		#define LCD_WIDTH 16
		#define LCD_HEIGHT 2
	#endif    
